...
require('lazy').setup({
  ...
  { -- You can easily change to a different colorscheme.
    ...
    init = function()
      ...
      -- vim.cmd.hi('Search gui=underline guibg=' .. colors['selection'] .. ' guifg=' .. colors['fg'])
      vim.cmd.hi('Search guibg=' .. colors['selection'] .. ' guifg=' .. colors['fg'])
      -- vim.cmd.hi('LspReferenceWrite gui=underline' .. ' guifg=' .. colors['fg'])
      -- this is used to override the color of the hover highlight from lspconfig
      vim.cmd.hi('LspReferenceWrite gui=underline' .. ' guifg=none')
      vim.cmd.hi('LspReferenceRead gui=underline' .. ' guifg=none')
      vim.cmd.hi('LspReferenceText gui=underline' .. ' guifg=none')
      -- vim.cmd.hi('LspReferenceText gui=underline' .. ' guifg=' .. colors['fg'])
      -- vim.cmd.hi 'CursorHold gui=underline'
      -- vim.cmd.hi 'CursorHoldI gui=underline'
      vim.cmd.hi('CurSearch guibg=' .. colors['selection'] .. ' guifg=' .. colors['fg'])
      -- vim.cmd.hi('Cursorline ctermbg=' .. colors['comment'] .. ' guibg=' .. colors['bg'])
      -- vim.cmd.hi('Cursorline ctermbg=White guibg=' .. colors['bg'])
      -- vim.cmd.hi('Cursorline term=underline guibg=' .. colors['comment'])
    end,
  },
  {
    'lervag/vimtex',
